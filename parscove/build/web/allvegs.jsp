<%-- 
    Document   : allvegs
    Created on : Jun 23, 2016, 6:18:44 PM
    Author     : shanmukh
--%>
...
<title>All Vegetarian Items</title>
</head>
<body>
...
<tr>
<th>Vegetarian Item ID</th>
<th>Vegetarian Item Name</th>
<th>Vegetarian Item price</th>

</tr>
<c:forEach var="row" items="${result.rows}">
<tr>
    <td><a href="${pageContext.request.contextPath}/GetVeg?id=${row.vegID}">${row.vegID}</a></td>
