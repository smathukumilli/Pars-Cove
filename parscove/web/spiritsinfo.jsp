<%-- 
    Document   : spiritsinfo
    Created on : Jun 23, 2016, 6:16:47 PM
    Author     : shanmukh
--%>
...
<html>
  ...
  <div class = "navbar-header">
      <a class = "navbar-brand" href = "test.html">Home</a>
       ...
       <table border="1">
            <td><a href="spiritsinfo.jsp">spirits Info</a></td>
            <td><a href="${pageContext.request.contextPath}/AllSpirits">All spirits</a></td>            
        </table>
        <br />

        <form action="${pageContext.request.contextPath}/SpiritsServlet" method="POST">
            <table>
                <tr>
                    <td>Spirit ID:</td>
                    <td><input type="text" name="id" value="${spirit.spiritID}"/></td>
                </tr>
                <tr>
                    <td>Spirit Name:</td>
                    <td><input type="text" name="name" value="${spirit.name}"/></td>
                </tr>
                <tr>
                    <td>Spirit Price</td>
                    <td><input type="text" name="price" value="${spirit.price}" /></td>
                </tr>
                <tr>
