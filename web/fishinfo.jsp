<%-- 
    Document   : fishinfo
    Created on : Jun 23, 2016, 6:17:53 PM
    Author     : shanmukh
--%>
  ...
  <div class = "navbar-header">
      <a class = "navbar-brand" href = "test.html">Home</a>
       ...
       <table border="1">
            ...
            <td><a href="${pageContext.request.contextPath}/AllFishs">All Fish Items</a></td>            
        </table>
        <br />

        <form action="${pageContext.request.contextPath}/FishServlet" method="POST">
            <table>
                <tr>
                    <td>Fish Item ID:</td>
                    <td><input type="text" name="id" value="${fish.fishId}"/></td>
                </tr>
                <tr>
                    <td>Fish Item Name:</td>
                    <td><input type="text" name="name" value="${fish.name}"/></td>
                </tr>
                <tr>
                    <td>Fish Item Price</td>
                    <td><input type="text" name="price" value="${fish.price}" /></td>
                </tr>
                <tr>
